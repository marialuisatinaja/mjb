            ...
            <div class="lg:col-span-4 col-span-12">
              <div class="card ">
                <div class="card-header ">
                  <h4 class="card-title">Therapists Serving</h4>
                    ...
                    <li class="flex items-center space-x-3 rtl:space-x-reverse border-b border-slate-100 dark:border-slate-700 last:border-b-0 pb-3 last:pb-0">
                      ...
                      <div class="flex items-center space-x-3 flex-1">
                        <div class="w-8 h-8 rounded-full overflow-hidden">
                          <img src="{{ asset('admin/assets/images/avatar/av-1.svg') }}" alt="User Avatar" class="w-full h-full object-cover">
                        </div>
                        <div class="text-start overflow-hidden text-ellipsis whitespace-nowrap max-w-full">
                          <div class="text-sm text-slate-600 dark:text-slate-300">
                            {{ optional($row->sales_details->user)->first_name }} {{ optional($row->sales_details->user)->middle_name }} {{ optional($row->sales_details->user)->last_name }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="flex-1 text-right">
                        <div class="text-sm font-light text-slate-400 dark:text-slate-400" style="color: green;">
                          Start Time : {{ $row->time}}
                        </div>
                      </div>
                      ...
                      <div class="flex-1 text-right">
                        <div class="text-sm font-light text-slate-400 dark:text-slate-400" style="color: green;">
                          {{ optional($row->sales_details->user)->status }}
                        </div>
                      </div>
                    </li>
